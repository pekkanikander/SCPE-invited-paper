...
Most of the research, presented use cases and applications have
assumed the use of some wireless connectivity technology although the
first ideas do not specifically refer to specific wireless or wired
networking, or to a any information and communications technology.

\begin{itemize}
  \item Motivation: Making physical context available and serviceable
...
\subsection{Defining {\it Internet of Things} and {\it
    Machine-to-Machine}}
...
\subsection{Classifying IoT devices -- power and security}
...
\subsection{Digital power management}
...
The Arduino project is a somewhat loose collaboration led a number of
