...
CoAP\cite{shelby2013constrained} sockets.  The TCP/IP stack is based on
...
compatible cloud runtime, such as AWS~\cite{AWS} or AppScale~\cite{AppScale}.
...
community~\cite{hertel2003motivation} and
XXX~\cite{Something-else-need-reference}.
