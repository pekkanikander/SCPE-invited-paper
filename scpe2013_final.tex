...
\thispagestyle{plain}
\fancypdcp{2}{scpe.v14i3.852}
\markboth{P. Nikander, V.~K. Rao, P. Liuha, and H. Tenhunen}{{ELL-i}}
...
not specifically refer to either wireless or wired networking,
...
function than mere sensing seems improbable.  Hence, it seems prudent
...
The ELL-i initiative is organised as a co-operative, providing an
...
of reducing the consumption of resources associated with buildings
...
\begin{figure}
\centering
\includegraphics[scale=.55]{2/figures/arch.eps}
...
IEEE 802.3at~\cite{802.3at} Power-over-Ethernet standard, which is an economical
...
typical case, it takes also (partial) responsibility for controlling
...
The power supply module consists of a Power-over-Ethernet signalling
...
The runtime system forms the basis of any firmware running on the
...
programming environments, with clear instructions on how to convert
...
\begin{figure}
\centering
\includegraphics[scale=.28]{2/figures/casedesign.eps}
...
\begin{figure}
\centering
\includegraphics[scale=.38]{2/figures/case.eps}
...
common platform-as-a-service (PAAS) denominator, which at the moment is
...
however, such an arrangement would be very inefficient for driving a
...
already a number of Power-over-Ethernet products on the market,
...
chosen MCU is a relatively simple but still a powerful one, from a
...
deviates from most typical business models, being closer to the Linux kernel
...
requires much more visibility than what ELL-i enjoys today and a
...
available in a form that is easier for relative newcomers to apply
...
of both individual developers and product companies, creating a
...
couple of euro.  Consequently, as even a typical light switch or toaster
...
\bibitem{akkaya2005survey}
Kemal Akkaya and Mohamed Younis.
\newblock A survey on routing protocols for wireless sensor networks.
\newblock {\em Ad hoc networks}, 3(3):325--349, 2005.
...
\newblock {\em Computer networks}, 38(4):393--422, 2002.

\bibitem{anderson2012makers}
Chris Anderson.
\newblock {\em Makers: the new industrial revolution}.
\newblock Random House, 2012.

\bibitem{ashton2009internet}
Kevin Ashton.
\newblock That '{I}nternet of {T}hings' thing.
\newblock {\em RFiD Journal}, 22:97--114, 2009.

\bibitem{Atzori20102787}
Luigi Atzori, Antonio Iera, and Giacomo Morabito.
\newblock The internet of things: A survey.
\newblock {\em Computer Networks}, 54(15):2787 -- 2805, 2010.

\bibitem{Baldauf2007a}
Matthias Baldauf, Schahram Dustdar, and Florian Rosenberg.
\newblock A survey on context-aware systems.
\newblock {\em Int. J. Ad Hoc Ubiquitous Comput.}, 2(4):263--277, June 2007.

\bibitem{ArduinoProject}
Massimo Banzi, David~A Mellis, David Cuartielles, Clay Shirky, Paul Badger, Tom
  Igoe, Federico Fissore, Roberto Guido, and Michael Shiloh.
\newblock Arduino.
\newblock The official Arduino web page at http://arduino.cc.

\bibitem{barry2008freertos}
Richard Barry.
\newblock Free{RTOS}.
\newblock {\em Internet, Oct}, 2008.

\bibitem{bennette1994recommended}
Adam Bennette.
\newblock {\em Recommended Practice for DMX512: A Guide for Users and
  Installers}.
\newblock United States Institute for Theatre Technology, 1994.

\bibitem{bushby1997bacnet}
Steven~T Bushby.
\newblock Bacnet: a standard communication infrastructure for intelligent
  buildings.
\newblock {\em Automation in Construction}, 6(5):529--540, 1997.

\bibitem{xtronix}
James Carter.
\newblock {\em Raspberry {P}i {P}ower over {E}thernet ({PoE}) Adapter by
  {X}tronix Ltd}.
\newblock Whitchurch Hill, Reading, Berks, United Kingdom, June 2013.

\bibitem{cerf1997next}
Vint Cerf.
\newblock The next 50 years of networking.
\newblock In {\em the ACM97 Conference Proceedings}, 1997.

\bibitem{chohan2010appscale}
Navraj Chohan, Chris Bunch, Sydney Pang, Chandra Krintz, Nagy Mostafa, Sunil
  Soman, and Rich Wolski.
\newblock App{S}cale: Scalable and open appengine application development and
  deployment.
\newblock In {\em Cloud Computing}, pages 57--70. Springer, 2010.

\bibitem{manual2001digital}
Digital addressable lighting interface activity group.
\newblock DALI Manual, Dali AG, ZVEI-Division Luminaires, 2001.

\bibitem{dunkels2003full}
Adam Dunkels.
\newblock Full {TCP/IP} for 8-bit architectures.
\newblock In {\em Proceedings of the 1st international conference on Mobile
  systems, applications and services}, pages 85--98. ACM, 2003.

\bibitem{dunkels2004contiki}
Adam Dunkels, Bjorn Gronvall, and Thiemo Voigt.
\newblock Contiki --- a lightweight and flexible operating system for tiny
  networked sensors.
\newblock In {\em Local Computer Networks, 2004. 29th Annual IEEE International
  Conference on}, pages 455--462. IEEE, 2004.

\bibitem{dunkels2006protothreads}
Adam Dunkels, Oliver Schmidt, Thiemo Voigt, and Muneeb Ali.
\newblock Protothreads: simplifying event-driven programming of
  memory-constrained embedded systems.
\newblock In {\em Proceedings of the 4th international conference on Embedded
  networked sensor systems}, pages 29--42. Acm, 2006.

\bibitem{EclipseM2M}
Eclipse foundation {M}achine-to-{M}achine industry working group -- charter.
\newblock Eclipse Foundation, Inc., Centrepointe Drive, Ottawa, Ontario,
  Canada.

\bibitem{fielding1999hypertext}
Roy Fielding, Jim Gettys, Jeffrey Mogul, Henrik Frystyk, Larry Masinter, Paul
  Leach, and Tim Berners-Lee.
\newblock Hypertext transfer protocol--http/1.1, 1999.

\bibitem{hamad2009energy}
Fadi Hamad, Leonid Smalov, Anne James, et~al.
\newblock Energy-aware security in m-commerce and the internet of things.
\newblock {\em IETE Technical review}, 26(5):357, 2009.

\bibitem{htbaset2011}
Introduction to {P}ower over {HDBaseT}.
\newblock HDBaseT Alliance, Beaverton, OR, USA, September 2011.

\bibitem{hertel2003motivation}
Guido Hertel, Sven Niedner, and Stefanie Herrmann.
\newblock Motivation of software developers in open source projects: an
  internet-based survey of contributors to the {L}inux kernel.
\newblock {\em Research policy}, 32(7):1159--1177, 2003.

\bibitem{hribernik2011co}
Karl~A Hribernik, Zied Ghrairi, Carl Hans, and K-D Thoben.
\newblock Co-creating the {I}nternet of {T}hings--first experiences in the
  participatory design of intelligent products with {A}rduino.
\newblock In {\em Concurrent Enterprising (ICE), 2011 17th International
  Conference on}, pages 1--9. IEEE, 2011.

\bibitem{802.3}
{IEEE} 802.3 standard for {E}thernet.
\newblock IEEE Computer Society, New York, NY, USA, December 2012.

\bibitem{802.3at}
{IEEE} 802.3at standard for {E}thernet. {A}mendment 3: {D}ata terminal
  equipment ({DTE}) power via the media dependent interface ({MDI})
  enhancements.
\newblock IEEE Computer Society, New York, NY, USA, September 2009.

\bibitem{LonTalk}
{IEC} 14908 {O}pen data communication in building automation, controls and
  building management - control network protocol.
\newblock International Electrotechnical Commission, rue de Varembe, Geneva,
  Switzerland.

\bibitem{ITU-T_FG_M2M}
{ITU-T} focus group on {M2M} service layer.
\newblock International Telecommunication Union, Telecommunication
  Standardization Bureau, Place des Nations, Geneva, Switzerland.

\bibitem{RaspiFoundationWikipedia}
Trevor Johnson, Steve Meirowsky, Johnathon Weare, Ryan Walmsley, and et.al.
\newblock Raspberry {P}i foundation.
\newblock Wikimedia Foundation, San Francisco, California, USA.

\bibitem{kindberg2002people}
Tim Kindberg, John Barton, Jeff Morgan, Gene Becker, Debbie Caswell, Philippe
  Debaty, Gita Gopal, Marcos Frid, Venky Krishnan, Howard Morris, et~al.
\newblock People, places, things: Web presence for the real world.
\newblock {\em Mobile Networks and Applications}, 7(5):365--376, 2002.

\bibitem{knx2011knx}
{KNX} standard.
\newblock KNX Association, De Kleetlaan, Brussels/Diegem, Belgium, 2011.

\bibitem{kuppuswamy2013crowdfunding}
Venkat Kuppuswamy and Barry~L Bayus.
\newblock Crowdfunding creative ideas: the dynamics of projects backers in
  {K}ickstarter.
\newblock Technical report, SSRN Working Paper, http://papers. ssrn.
  com/sol3/papers. cfm, 2013.

\bibitem{lattner2004llvm}
Chris Lattner and Vikram Adve.
\newblock {LLVM}: A compilation framework for lifelong program analysis \&
  transformation.
\newblock In {\em Code Generation and Optimization, 2004. CGO 2004.
  International Symposium on}, pages 75--86. IEEE, 2004.

\bibitem{lee2003firm}
Gwendolyn~K Lee and Robert~E Cole.
\newblock From a firm-based to a community-based model of knowledge creation:
  The case of the {L}inux kernel development.
\newblock {\em Organization Science}, 14(6):633--649, 2003.

\bibitem{lopez2012adding}
Tom{\'a}s~S{\'a}nchez L{\'o}pez, Damith~C Ranasinghe, Mark Harrison, and Duncan
  McFarlane.
\newblock Adding sense to the internet of things.
\newblock {\em Personal and Ubiquitous Computing}, 16(3):291--308, 2012.

\bibitem{ArduinoIDEextension}
Cristian Maglie.
\newblock Arduino {IDE} 1.5 3rd party hardware specification.

\bibitem{maniktala2012switching}
Sanjaya Maniktala.
\newblock {\em Switching power supplies {A} to {Z}}.
\newblock Elsevier, 2012.

\bibitem{ArduinoPolicy}
David~A Mellis, David Cuartielles, Federico Fissore, and Alberto Cicchi.
\newblock So you want to make an {A}rduino.

\bibitem{ENC28J60}
{\em {ENC28J60} Data Sheet -- {S}tand-Alone {E}thernet Controller with {SPI}
  Interface}.
\newblock Microchip Technology Inc., West Chandler Blvd., Chandler, Arizona,
  USA, 2008.

\bibitem{miorandi2012internet}
...
\newblock {\em Ad Hoc Networks}, 10(7):1497--1516, 2012.

\bibitem{ModBus}
Modbus application protocol specification v1.1b.
\newblock Modbus Organization, Hopkinton, MA, USA, December 2006.

\bibitem{Olson2002}
Deborah~Groban Olson and John Logue.
\newblock Fix globalization: Make it more inclusive, democratic, accountable
  and sustainable.
\newblock Capital Ownership Group, Ford Foundation, October 2002.

\bibitem{RasPi}
Raspberry {P}i.
\newblock Rasberry Pi Foundation, Caldecote, Cambridgeshire, UK.

\bibitem{rintaaho2012clicktofpga}
Teemu Rinta-aho, Mika Karlstedt, and Madhav~P Desai.
\newblock The {Click2NetFPGA} toolchain.
\newblock In {\em USENIX Annual Technical Conference}, 2012.
...
\bibitem{rowland2002prevalence}
Diane Rowland, Carolyn DiGuiseppi, Ian Roberts, Katherine Curtis, Helen
  Roberts, Laura Ginnelly, Mark Sculpher, and Angela Wade.
\newblock Prevalence of working smoke alarms in local authority inner city
  housing: randomised controlled trial.
\newblock {\em Bmj}, 325(7371):998, 2002.

\bibitem{shelby2013constrained}
Zach Shelby, Klaus Hartke, and Carsten Bormann.
\newblock Constrained application protocol ({CoAP}).
\newblock Technical report, Internet Engineering Task Force, 2013.

\bibitem{ArduinoEthernetShieldPOE}
{\em Arduino {E}thernet Shield with {PoE}}.
\newblock Spark Fun Electronics Inc., Longbow Drive, Boulder, Colorado, USA,
  2013.

\bibitem{ArduinoEthernetPOE}
{\em Arduino {E}thernet with {PoE}}.
\newblock Spark Fun Electronics Inc., Longbow Drive, Boulder, Colorado, USA,
  2013.

\bibitem{POEthernetShield}
{\em {POE}thernet Shield}.
\newblock Spark Fun Electronics Inc., Longbow Drive, Boulder, Colorado, USA,
  2013.

\bibitem{STM32F051}
{\em {STM32F05xxx/06xxx} advanced {ARM}-based 32-bit {MCU}s, Reference Manual},
  May 2013.

\bibitem{vermesan2011internet}
Ovidiu Vermesan, Peter Friess, Patrick Guillemin, Sergio Gusmeroli, Harald
  Sundmaeker, Alessandro Bassi, Ignacio~Soler Jubert, Margaretha Mazura, Mark
  Harrison, M~Eisenhauer, et~al.
\newblock {\em Cluster SRA 2011}, chapter Internet of {T}hings strategic
  research roadmap, pages 9--52.
\newblock European Research Cluster on the Internet of Things, 2011.

\bibitem{wang2010toward}
Zhong~Lin Wang.
\newblock Toward self-powered sensor networks.
\newblock {\em Nano Today}, 5(6):512--514, 2010.

\bibitem{weiser1991computer}
Mark Weiser.
\newblock The computer for the 21st century.
\newblock {\em Scientific american}, 265(3):94--104, 1991.

\bibitem{wu2011m2m}
Geng Wu, Shilpa Talwar, Kerstin Johnsson, Nageen Himayat, and Kevin~D Johnson.
\newblock M2m: From mobile to embedded internet.
\newblock {\em Communications Magazine, IEEE}, 49(4):36--43, 2011.

\end{thebibliography}

\editedby{Ethiopia Nigussie, Andreas Riener and Liang Guang}{Sep 1, 2013}{Sep 30, 2013}
\label{END2}
